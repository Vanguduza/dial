...
| Field | Value |
| --- | --- |
| `current_stage` | **S256** — served x-dial-sor.docs matches disk — **green** |
| `current_issue` | _(auto)_ |
| `current_branch` | `build/t4-tech-ui` |
| `prior_stage` | **S255** served probes SoR pointer — **green** |
| `next_stage` | **S257** |
...
| Stage | When | Evidence |
| --- | --- | --- |
| S91–S255 | 2026-08-13/14 | through prior |
| S256 | 2026-08-14 | served x-dial-sor.docs matches disk |
