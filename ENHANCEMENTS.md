...
| ENH-030 | **API key-drop-in adapters** — Pack/Stitch HTTP shapes + fixture/sandbox/live mode; per-vendor webhooks | `in_progress` | S91 — `docs/integrations/README.md`; fill keys → set `DIAL_INTEGRATION_MODE` |
