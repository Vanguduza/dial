...
| ENH-604 | **Completion eng-safe prep Phases 3–12 (not G3–G12)** — native URL flavors, privacy/signing drafts, G3 HTTP probe, Temporal/maps/WHT/WA_FLOW/CC/hardening; admin K/G/P dormant shells; P4/P5 gateway fixture CI | `in_progress` | **Phase 3 current (not G3)**; native contract probe loopback green; G3 blocked on staging URL + Play/TestFlight + device PNGs |
...
| ENH-605 | **Completion Phase 5 prep (not G5)** — Temporal compose + dispatch contracts | `in_progress` | Temporal + workflow history + durable POD + **admin T+S+A recon green**; G5 open — ENH-013 maps Tier-2 + device POD |
