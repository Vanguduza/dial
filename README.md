...
**Build status:** eng spine **S90** green; product-depth through **PD126** Formance Console explorer. Path to production: **S90 → PD… → S99**. **S99** remains human launch-only. **PD99 ≠ S99.** OpenAPI invent paused. No liquor Build.
