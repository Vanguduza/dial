...
**Build status:** eng spine **S90** green; product-depth through **PD18** Spare-web deepen green → next **PD19** Admin Trade/JobClass + Value Score. **S99** remains human launch-only. OpenAPI invent paused. No liquor Build.
