...
**Build status:** eng spine **S90** green; product-depth through **PD50** Vehicle Hub deepen (returns admin + escrow sandbox). **S99** remains human launch-only (not product-finished). OpenAPI invent paused. No liquor Build.
