...
**Build status:** eng spine **S90** green; product-depth through **PD27** Spare dual-entry EPC green → next **PD28** delivery availability/offline. **S99** remains human launch-only (not product-finished). OpenAPI invent paused. No liquor Build.
