...
**Build status:** eng spine **S90** green; product-depth through **PD17** Intelligence Factory shadow/promote green → next **PD18** Spare-web deepen. **S99** remains human launch-only. OpenAPI invent paused. No liquor Build.
