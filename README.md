...
**Build status:** eng spine **S90** green; product-depth through **PD28** delivery availability/offline packs green → next **PD29** delivery ETA/stops. **S99** remains human launch-only (not product-finished). OpenAPI invent paused. No liquor Build.
