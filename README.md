...
**Build status:** eng spine **S90** green; product-depth through **PD7** Delivery Android green → next **PD8** Customer iOS. **S99** remains human launch-only. OpenAPI invent paused. No liquor Build.
