...
**Build status:** eng spine **S90** green; product-depth through **PD29** delivery ETA/stops/VROOM green → next **PD30** technician mock-location/camera. **S99** remains human launch-only (not product-finished). OpenAPI invent paused. No liquor Build.
