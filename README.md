...
**Build status:** eng spine **S90** green; product-depth through **PD15** Catalogue Factory admin green → next **PD16** Promotions & referrals admin. **S99** remains human launch-only. OpenAPI invent paused. No liquor Build.
