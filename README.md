...
**Build status:** eng spine **S90** green; product-depth through **PD26** gateway home Shop|Services green → next **PD27** Spare EPC/vehicle dual entry. **S99** remains human launch-only (not product-finished). OpenAPI invent paused. No liquor Build.
