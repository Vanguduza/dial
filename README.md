...
**Build status:** eng spine **S90** green; product-depth through **PD86** Manager's choice flag. **S99** remains human launch-only (not product-finished). OpenAPI invent paused. No liquor Build.
