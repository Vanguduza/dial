...
**Build status:** eng spine **S90** green; product-depth through **PD45** support/consent admin. **S99** remains human launch-only (not product-finished). OpenAPI invent paused. No liquor Build.
