...
**Build status:** eng spine **S90** green; product-depth through **PD10** Admin money/dispatch/Command Centre green → next **PD11** FDMS sandbox (then PD12 WA Flows). **S99** remains human launch-only. OpenAPI invent paused. No liquor Build.
