...
**Build status:** eng spine **S90** green; product-depth through **PD13** tech-web green → next **PD14** grocery web deepen. **S99** remains human launch-only. OpenAPI invent paused. No liquor Build.
