...
**Build status:** eng spine **S90** green; product-depth through **PD37** local Playwright recon green. **S99** remains human launch-only (not product-finished). OpenAPI invent paused. No liquor Build.
